...
class CaseController extends CommonController{
    ...
    public function pagelist(){
        if (IS_POST) {
            $ret=$this->ctx->CaseManager->getList();
            $this->ajaxReturn($ret);
        }else{
            $ret=$this->ctx->CaseCategoryManager->getCategory();
    ...
    public function show(){
        ...
        $map=$this->ctx->CaseModel->findByShow(I('id'));
        if ($map['pic']) {
    ...
    public function setPass(){
        $ret=$this->ctx->CaseManager->setPass();
        $this->ajaxReturn($ret);
    }

    public function setRecommend(){
        $ret=$this->ctx->CaseManager->setRecommend();
        $this->ajaxReturn($ret);
    }
    ...
    public function remove(){
        $ret=$this->ctx->CaseManager->remove();
        $this->ajaxReturn($ret);
    }
}