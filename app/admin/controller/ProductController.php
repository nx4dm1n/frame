...
class ProductController extends CommonController{
    ...
    public function pagelist(){
        if (IS_POST) {
            $ret=$this->ctx->ProductManager->getList();
            $this->ajaxReturn($ret);
        }else{
    ...
    public function show(){
        ...
        $map=$this->ctx->ProductModel->findByShow(I('id'));
        if ($map['pic']) {
    ...
    public function save(){
        $ret=$this->ctx->ProductManager->save();
        $this->ajaxReturn($ret);
    }
    ...
    public function setPass(){
        $ret=$this->ctx->ProductManager->setPass();
        $this->ajaxReturn($ret);
    }

    public function setRecommend(){
        $ret=$this->ctx->ProductManager->setRecommend();
        $this->ajaxReturn($ret);
    }
    ...
    public function remove(){
        $ret=$this->ctx->ProductManager->remove();
        $this->ajaxReturn($ret);
    }
}