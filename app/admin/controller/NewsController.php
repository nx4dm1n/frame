...
class NewsController extends CommonController{
    ...
    public function pagelist(){
        if (IS_POST) {
            $ret=$this->ctx->NewsManager->getList();
            $this->ajaxReturn($ret);
        }else{
    ...
    public function show(){
        ...
        $map=$this->ctx->NewsModel->findByShow(I('id'));
        if ($map['pic']) {
    ...
    public function setPass(){
        $ret=$this->ctx->NewsManager->setPass();
        $this->ajaxReturn($ret);
    }

    public function setRecommend(){
        $ret=$this->ctx->NewsManager->setRecommend();
        $this->ajaxReturn($ret);
    }
    ...
    public function remove(){
        $ret=$this->ctx->NewsManager->remove();
        $this->ajaxReturn($ret);
    }
}