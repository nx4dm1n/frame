...
class VideoCategoryController extends CommonController{
    ...
    public function show(){
        ...
        if (!empty($id)) {
            $ret=$this->ctx->VideoCategoryModel->find($id);
            if (false!==$ret) {
                $map=$ret;
            }
        }else{
    ...
    public function save(){
        $ret=$this->ctx->VideoCategoryManager->save();
        $this->ajaxReturn($ret);
    }
    ...
    public function remove(){
        $ret=$this->ctx->VideoCategoryManager->remove();
        $this->ajaxReturn($ret);
    }
}