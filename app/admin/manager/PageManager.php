...
class PageManager extends Manager{
    ...
    public function save(){
        ...
        $ret=$this->ctx->PageModel->save(I('id'), $map);
    ...
    public function getList(){
        ...
        $total      =$this->ctx->PageModel->getCount(array());   // 总的记录数
        $filtered   =$this->ctx->PageModel->getCount($where);    // 搜索关键词过滤后记录数
        $data['draw']               =I('draw');
        ...
        $result=$this->ctx->PageModel->getAll('*', $where);
    ...
    public function setPass(){
        ...
        $ret=$this->ctx->PageModel->modify($data, $where);
    ...
    public function remove(){
        ...
        $ret=$this->ctx->PageModel->remove($where);
