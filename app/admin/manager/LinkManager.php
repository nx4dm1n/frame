...
class LinkManager extends Manager{
    ...
    public function save(){
        ...
        $ret=$this->ctx->LinkModel->save(I('id'), $map);
    ...
    public function getList(){
        ...
        $total      =$this->ctx->LinkModel->getCount(array());   // 总的记录数
        $filtered   =$this->ctx->LinkModel->getCount($where);    // 搜索关键词过滤后记录数
        $data['draw']               =I('draw');
        ...
        $result=$this->ctx->LinkModel->getAll('*', $where);
    ...
    public function setPass(){
        ...
        $ret=$this->ctx->LinkModel->modify($data, $where);
    ...
    public function remove(){
        ...
        $ret=$this->ctx->LinkModel->remove($where);
