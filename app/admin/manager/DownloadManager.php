...
class DownloadManager extends Manager{
    ...
    public function save(){
        ...
        $ret=$this->ctx->DownloadModel->save(I('id'), $map);
    ...
    public function getList(){
        ...
        $total      =$this->ctx->DownloadModel->getCount(array());   // 总的记录数
        $filtered   =$this->ctx->DownloadModel->getCount($where);    // 搜索关键词过滤后记录数
        $data['draw']               =I('draw');
        ...
        $result=$this->ctx->DownloadModel->getAll('*', $where);
        foreach ($result as $key=>$record) {
            $category_name=$this->ctx->DownloadCategoryModel->find($record['classid'], 'name');
            $data['data'][]=array(
    ...
    public function setPass(){
        ...
        $ret=$this->ctx->DownloadModel->modify($data, $where);
    ...
    public function remove(){
        ...
        $ret=$this->ctx->DownloadModel->remove($where);
