...
class NewsManager extends Manager{
    ...
    public function save(){
        ...
        $ret=$this->ctx->NewsModel->save(I('id'), $map);
    ...
    public function getList(){
        ...
        $total      =$this->ctx->NewsModel->getCount(array());   // 总的记录数
        $filtered   =$this->ctx->NewsModel->getCount($where);    // 搜索关键词过滤后记录数
        $data['draw']               =I('draw');
        ...
        $result=$this->ctx->NewsModel->getAll('*', $where);
        foreach ($result as $key=>$record) {
            $category_name=$this->ctx->NewsCategoryModel->find($record['classid'], 'name');
            $data['data'][]=array(
    ...
    public function setPass(){
        ...
        $ret=$this->ctx->NewsModel->modify($data, $where);
    ...
    public function remove(){
        ...
        $ret=$this->ctx->NewsModel->remove($where);
