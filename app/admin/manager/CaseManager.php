...
class CaseManager extends Manager{
    ...
    public function save(){
        ...
        $ret=$this->ctx->CaseModel->save(I('id'), $map);
    ...
    public function getList(){
        ...
        $total      =$this->ctx->CaseModel->getCount(array());   // 总的记录数
        $filtered   =$this->ctx->CaseModel->getCount($where);    // 搜索关键词过滤后记录数
        $data['draw']               =I('draw');
        ...
        $result=$this->ctx->CaseModel->getAll('*', $where);
        foreach ($result as $key=>$record) {
            $category_name=$this->ctx->CaseCategoryModel->find($record['classid'], 'name');
            $data['data'][]=array(
    ...
    public function setPass(){
        ...
        $ret=$this->ctx->CaseModel->modify($data, $where);
    ...
    public function remove(){
        ...
        $ret=$this->ctx->CaseModel->remove($where);
