...
class DownloadCategoryManager extends Manager{
    ...
    public function save(){
        ...
        $ret=$this->ctx->DownloadCategoryModel->save(I('id'), $map);
    ...
    public function getCategory($pid=0, $delimiter='──',$spac=0,  $root_delimiter=false, &$result=array()){
        ...
        $ret=$this->ctx->DownloadCategoryModel->getCategory($pid);
    ...
    public function remove(){
        ...
        $id=I('id');
        $ret=$this->ctx->DownloadCategoryModel->remove($id);
