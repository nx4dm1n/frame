...
class CaseCategoryManager extends Manager{
    ...
    public function save(){
        ...
        $ret=$this->ctx->CaseCategoryModel->save(I('id'), $map);
    ...
    public function getCategory($pid=0, $delimiter='──',$spac=0,  $root_delimiter=false, &$result=array()){
        ...
        $ret=$this->ctx->CaseCategoryModel->getCategory($pid);
    ...
    public function remove(){
        ...
        $id=I('id');
        $ret=$this->ctx->CaseCategoryModel->remove($id);
