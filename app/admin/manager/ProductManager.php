...
class ProductManager extends Manager{
    ...
    public function save(){
        ...
        $ret=$this->ctx->ProductModel->save(I('id'), $map);
    ...
    public function getList(){
        ...
        $total      =$this->ctx->ProductModel->getCount(array());   // 总的记录数
        $filtered   =$this->ctx->ProductModel->getCount($where);    // 搜索关键词过滤后记录数
        $data['draw']               =I('draw');
        ...
        $result=$this->ctx->ProductModel->getAll('*', $where);
        foreach ($result as $key=>$record) {
            $category_name=$this->ctx->ProductCategoryModel->find($record['classid'], 'name');
            $data['data'][]=array(
    ...
    public function setPass(){
        ...
        $ret=$this->ctx->ProductModel->modify($data, $where);
    ...
    public function remove(){
        ...
        $ret=$this->ctx->ProductModel->remove($where);
